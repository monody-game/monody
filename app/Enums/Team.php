...
enum Team: int
{
    ...
    {
        return match ($this) {
            self::Villagers => [Role::SimpleVillager, Role::Psychic, Role::Witch, Role::LittleGirl, Role::Elder, Role::Cupid, Role::Guard],
    ...
    public static function role(Role $role): self
    {
        return match ($role) {
            ...
            Role::SimpleVillager, Role::Psychic, Role::Witch, Role::LittleGirl, Role::Elder, Role::Cupid, Role::Guard => self::Villagers,
