...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function addData($type, $content)
        {
                        return \Illuminate\Http\JsonResponse::addData($type, $content);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function withAlert($type, $content)
        {
                        return \Illuminate\Http\JsonResponse::withAlert($type, $content);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function withPopup($type, $content, $note = null, $link = null, $linkText = null)
        {
                        return \Illuminate\Http\JsonResponse::withPopup($type, $content, $note, $link, $linkText);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\JsonResponse::withContent($content);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Http\JsonResponse::withMessage($message);
        }
