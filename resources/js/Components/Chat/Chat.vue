<template>
    <div class="chat__main">
        ...
        <div class="chat__submit-form">
            <input type="text" placeholder="Envoyer un message" class="chat__send-input" v-model="message" :class="isReadonly()" :readonly="isNight()" @keyup.enter="send()">
            <button class="chat__send-button" @click="send()">
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" class="chat__submit-icon">
