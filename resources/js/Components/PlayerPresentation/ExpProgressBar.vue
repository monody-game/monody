...
const progress = (53 * exp) / 100;
const progressStyle = `background-image: conic-gradient(from -97deg at 49% 91%, #FFF5CF 0 ${progress}%, #FFFCF1 0);`;
</script>
