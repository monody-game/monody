...
const share = async () => {
	...
	if (res.ok) {
		alertStore.addAlerts({
			success: "Votre partie a été partagée sur Discord !",
		});
	} else {
		alertStore.addAlerts({
			warn: "Une erreur est survenue... La partie a-t-elle déjà été partagée ?",
		});
	}
...
const twitterLink = computed(() => {
	return (
		"https://twitter.com/intent/tweet?text=Rejoignez%20moi%20dans%20ma%20partie%20Monody%F0%9F%8C%99%20%21%20" +
