		...
		<div class="auth-page__wrapper">
			...
			>
				...
				<template #restriction>
					<div v-if="token === null" class="auth-page__lock">
						<div class="auth-page__locked-popup">
							<div class="popup__wrapper" data-popup-type="warn">
								...
								<p class="popup__content">
									Vous ne pouvez pas créer de compte Monody pendant la phase de
									beta.
								</p>
								<p class="popup__note">
			...
			for (const field in validationErrors) {
				if (validationErrors[field].includes("validation.unique")) {
					errors.value[field].text =
						"Un compte utilisant cette valeur existe déjà";
