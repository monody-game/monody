...
export class InteractionService {
	static async openInteraction(io, channel, type) {
		...
		const res = await fetch(`${process.env.APP_URL}/api/interactions`, { method: "POST", body: params });
	...
	static async closeInteraction(io, channel, type) {
		...
		await fetch(`${process.env.APP_URL}/api/interactions`, { method: "DELETE", body: params });
